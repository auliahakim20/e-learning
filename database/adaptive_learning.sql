...
--
-- Table structure for table `absenmember`
--

CREATE TABLE `absenmember` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `absenmember`
--

INSERT INTO `absenmember` (`id`, `name`, `course`, `pertemuan`, `status`, `tanggal`) VALUES
(1, 'Hakim', 'Natural Language Processing', 'Pertemuan 1', 'Hadir', '2021-06-14 23:25:26'),
(2, 'Dicky', 'PHP', 'Pertemuan 1', 'Hadir', '2021-06-14 23:26:17');
...
('/member/create', 2, NULL, NULL, NULL, 1623732466, 1623732466),
...
('Member', 1, NULL, NULL, NULL, 1572674892, 1623732476),
...
INSERT INTO `member` (`id`, `name`, `course`, `pertemuan`, `keterangan`, `tanggal`) VALUES
(1, 'Aulia Hakim', 'PHP', 1, 'Hadir', '2021-06-15 09:48:36'),
(2, 'Abraham', 'PHP', 2, 'Hadir', '2021-06-15 11:30:51'),
(3, 'Dicky M', 'Kalkulus', 3, 'Hadir', '2021-06-15 11:48:56'),
(4, 'Rizky', 'PHP', 1, 'Hadir', '2021-06-15 12:07:50'),
(5, 'Tito', 'Data Mining', 1, 'Hadir', '2021-06-15 12:08:32'),
(8, 'Nicolas', 'Image Processing', 2, 'Hadir', '2021-06-15 12:28:01');
...
(1, 'admin', 'edyagusc@gmail.com', '$2y$10$INAPuvkeYguFyiGrAhzVIuJ7FgTWwsQu4q.Ki8kYy7rXTfwuH/Zg.', 'Zex96X-pU8T4v6HnvKWkF5Ktp3gvD1VN', 1572096547, NULL, NULL, '172.22.0.1', 1572096302, 1576587814, 0, 1623732516),
...
(103, 'member', 'member@gmail.com', '$2y$10$rg.hG8zL5vw.Mi.4nPEDGeKildAjpWHhbWwZzy5v3npEmSl7NZOSO', '5zF6i7PnbD2ZVK-ogTUXUP6qpO4d0MqO', 1580634807, NULL, NULL, '36.79.47.223', 1580634807, 1580634807, 0, 1623732498),
...
--
-- Indexes for table `absenmember`
--
ALTER TABLE `absenmember`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `absenmember`
--
ALTER TABLE `absenmember`
